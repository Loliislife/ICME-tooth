...
if __name__ == '__main__':
    ...
    for index in range(100):
        ...
        matrix_low_0 = torch.Tensor(m0.matrix_low_0.cpu())
        matrix_low_1 = torch.Tensor(m0.matrix_low_1.cpu())
        matrix_high_0 = torch.Tensor(m0.matrix_high_0.cpu())
        matrix_high_1 = torch.Tensor(m0.matrix_high_1.cpu())
    ...
    image_re_np = image_re.cpu().detach().numpy()
    ...
    #     m0 = DWT_1D('haar')
    #     L, H = m0(vector.cuda())
    #     matrix_low = m0.matrix_low
    #     matrix_high = m0.matrix_high
    #     vector.requires_grad = True
    #     input = (vector.double().cuda(), matrix_low.double(), matrix_high.double())
    ...
    #     vector_re = m1(L, H)
    # t1 = datetime.now()
    # vector_re_np = vector_re.detach().cpu().numpy()
